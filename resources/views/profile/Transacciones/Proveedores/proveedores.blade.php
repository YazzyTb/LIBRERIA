    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <main class="flex-1 p-4">
            <div class="container mx-auto py-8">
                <h1 class="text-3xl font-bold mb-6 text-gray-700">Listado de Proveedores</h1>
                
                <!-- Search and Register Button -->
                <div class="flex items-center justify-between mb-6">
                    <a href="{{ route('proveedor.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300">
                        Nuevo Proveedor
                    </a>
                    
                    <!-- Search Input -->
                    <div class="relative w-full max-w-sm ml-auto">
                        <input type="text" id="searchInput" onkeyup="filterTable()" placeholder="Buscar Proveedor..."
                    ...
                    <table id="clienteTable" class="min-w-full bg-white rounded-lg">
                        <thead class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal sticky top-0">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left font-medium">Persona de Contacto</th>
                                <th class="px-6 py-3 text-left font-medium">Telefono de Contacto</th>
                        ...
                        <tbody class="text-gray-700 text-sm font-light">
                            @foreach($proveedores as $proveedor)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $proveedor->persona_de_contacto }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $proveedor->telefono_de_contacto }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('proveedor.edit', $proveedor->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-3 rounded-lg transition duration-300">
                                                Editar
                                            </a>
